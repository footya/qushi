...
define(function (require, exports, module) {
    ...
    module.exports = lib.Class('ItemPraiseWordsPieChartView',{
        ns: 'lib.v',
        extend: View,
        ...
        methods:{
            ...
            // },
            updateAll:function() {
                this._ctrl.notice({"type":"updateChartView","data":this.getParam()});
            },
            updateChartView:function (data){
                new Highcharts.Chart({
                    chart: {
                        renderTo: this._opt.id,
            ...
            getParam:function() {
                ...
                _params["type"]  = this._opt.type;
                _params["pid"]   = this._opt.pid;//[todo]获取pid
